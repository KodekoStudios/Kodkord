...
export class GuildMediaChannel extends BaseGuildChannel {
	...
	/**
	 * Retrieves the ID of the guild this media channel belongs to.
	...
	/**
	 * The rate limit (in seconds) per user for posting content in this media channel.
	...
	/**
	 * The topic of this media channel, often used as a description or purpose.
	...
	/**
	 * The default auto-archive duration (in minutes) for threads in this media channel.
	...
	/**
	 * The default sort order for threads in this media channel.
	...
	/**
	 * The default reaction emoji for threads in this media channel.
