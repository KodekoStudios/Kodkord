...
Defined in: kodkord-dev/lib/index.d.ts:184
...
Defined in: kodkord-dev/lib/index.d.ts:198
...
[`Dictionary`](/api/core/dev/classes/dictionary/)\<`Key`, `Type`\>
...
[`Dictionary`](/api/core/dev/classes/dictionary/)\<`Key`, `T`\>
