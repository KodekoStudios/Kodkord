...
CLIENT.connect();
  ```
<Aside type="tip">
We recommend you to add everything important like your bot token in a `.env` file, visit [Environment variables](/guides/tips/env-variables) for more information.
...
```js title="src/index.js" copy wrap twoslash
...
CLIENT.connect();
```
<Aside type="tip">We recommend you to add everything important like your bot token in a `.env` file, visit [Environment variables](/guides/tips/env-variables) for more information.</Aside>
  </TabItem>
</Tabs>
