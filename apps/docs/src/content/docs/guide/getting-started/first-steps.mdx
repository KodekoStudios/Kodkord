...
CLIENT.connect();
  ```
<Aside type="tip">
We recommend you to add everything important like your bot token in a `.env` file, visit [Environment variables](/guides/en/tips/env-variables) for more information.
